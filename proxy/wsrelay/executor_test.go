...
// TestPrepareWebsocketHeadersStripsAttestation 验证 WS 路径同样不透传 DeviceCheck
// token（openai/codex#20619），缺失时也不伪造。
func TestPrepareWebsocketHeadersStripsAttestation(t *testing.T) {
	exec := NewExecutor()
