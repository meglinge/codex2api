...
func newRustSenderTransport(proxyURL string) http.RoundTripper {
...
func RustSenderWebsocketDial(wsURL string, headers http.Header, proxyURL string) (string, http.Header, bool) {
